		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Nautical Vendor",
									"targetURL": "#comingenxnautinauticalvendor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comingenxnautinauticalvendor-display": {
								"semanticObject": "comingenxnautinauticalvendor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ingenx.nauti.nauticalvendor",
									"url": sap.ui.require.toUrl("com/ingenx/nauti/nauticalvendor")
								}
							}
						}
					}
